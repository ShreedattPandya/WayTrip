    ...
    <footer className="pt-5">
      <Container>
        <Row>
          ...
          <a target="_blank" href="mailto:shreepandyaa12@gmail.com" className="d-block" >shreepandyaa12@gmail.com</a>
          </div>
          <div className="d-flex align-items-top ">
          <i className="bi bi-telephone me-3"></i>
          <a target="_blank" href="tel:9157733002" className="d-block" >9157733002</a>
          </div>
