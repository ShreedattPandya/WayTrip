        ...
        <Container>
          <Row>
            ...
            <Col md="3" sm="12" className="location mt-3 mt-md-0 ">
              ...
              <div className="d-flex align-items-center">
                <p className="pb-2"> Vadodara, Gujarat, India</p>
              </div>

              <div className="d-flex align-items-top my-2">
                <i className="bi bi-geo-alt me-3"></i>
                <a target="_blank" rel="noreferrer" href="mailto:shreepandyaa12@gmail.com" className="d-block" >shreepandyaa12@gmail.com</a>
              </div>
              <div className="d-flex align-items-top ">
                <i className="bi bi-telephone me-3"></i>
                <a target="_blank" rel="noreferrer" href="tel:9157733002" className="d-block" >9157733002</a>
              </div>
          ...
          <Row className="py-2 bdr mt-3">
            <Col className="col copyright">
              <p className="text-light">   @ 2025.  All rights reserved </p>
            </Col>
          </Row>
